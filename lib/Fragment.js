...
(function (root, fragFactory) {
	...
	*/
		...
		var lengthProps = function ( chars, hasLeading ) {
		/* ( Str ) -> this Fragment
		* 
		...
		*/
			...
			// if ( length < 5 ) { frag.isShort = true; }
			// else if ( length > 12 ) { frag.isLong = true; }
