...
* 
* TODO:
* ??: Add events for things like opening and closing?
* ??: Should there be an 'x' in the corner for closing settings?
* ??: Attach this object to mainDisplay?
*/
...
(function (root, settingsFactory) {  // root is usually `window`
	...
	var ReaderlySettings = function ( timer, mainDisplay ) {
		...
		// rSet._createCustomEvents = function () {
		// 	if ( document.createEvent ) {
		// 		rSet._destroyOne = document.createEvent( 'destroyOneSettingsMenu' );
		// 	} else {
		// 		rSet._destroyOne = new CustomEvent( 'destroyOneSettingsMenu' );
		// 	}
		// 	return rSet;
		// };
		...
		*/
		...
		rSet.addMenu = function ( elem, tabText ) {
