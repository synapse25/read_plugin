...
(function (root, playbackFactory) {  // root is usually `window`
	...
	var ReaderlyPlayback = function ( timer, displayCore ) {
		...
		var progress, percentDone, scrubber;
...
/////////////////////////////////////
		...
		// This is where everything gets closed, paused, put away
			rPly.hide();
			for (var closei = 0; closei < rPly._toClose.length; closei++) {
				rPly._toClose[ closei ].close();
			};
			return rPly;
		};
...
////////////////////////////////////////
		...
		rPly._showProgress = function ( evnt, timer, fraction ) {
